...
const YPRewardCard = ({ nfts, reward, revenue }: Props) => {
  return (
    <div className="flex items-center gap-4 justify-between p-2 pr-4 rounded-[1rem] bg-black border-[1px] border-white border-opacity-10 flex-wrap">
