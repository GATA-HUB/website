...
const ManagedLiquidityCard = ({ totalLPValue }: { totalLPValue: number }) => {
  return (
    <div className="relative w-full flex flex-col md:flex-row gap-8 justify-between md:items-center p-8 rounded-xl bg-black overflow-hidden">
      <div className="z-[1] flex flex-col md:flex-row gap-4 md:items-center">
        ...
        <h3 className="text-[28px] lg:text-[32px] text-black">
          Managed Liquidity
        </h3>
      </div>
