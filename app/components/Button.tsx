    ...
    <>
      {disabled ? (
        ...
        <div
          ...
          className={`w-${
            width || "fit"
          } group flex pl-4 pr-1 py-1 gap-4 justify-between items-center text-center rounded-[8px] bg-dgray border-2 border-purple font-titillium font-semibold uppercase text-white text-[14px] hover:bg-purple hover:text-dgray hover:border-white hover:border-opacity-10 transition-all duration-300 ease-in-out cursor-pointer sm:pl-4 sm:pr-2 sm:py-2 3xl:pl-[24px] 3xl:pr-[8px] 3xl:py-[8px] sm:text-[14px]`}
        >
          {children}
