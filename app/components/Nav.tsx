    ...
    <div className="z-30 fixed top-0 left-0 w-full px-2 pt-2 md:px-4 md:pt-4 flex justify-center">
      <nav className="relative w-full max-w-[1888px] flex justify-between items-center border-2 border-white border-opacity-10 bg-purple rounded-2xl pl-[18px] pr-[18px] py-[8px]">
        ...
        <div className="hidden lg:flex gap-[40px] lg2:gap-[64px]">
          ...
          {/* dApp Button */}
          {/* <div
            className="group relative gap-[12px] px-[24px] py-[12px] h-fit flex items-center rounded-[8px] bg-dgray cursor-pointer border-2 border-white border-opacity-10 transition-all duration-300 ease-in-out hover:bg-purple hover:border-dgray hover:border-opacity-100"
          ...
          {/* <div
              ...
              } w-[max-content] transition-all duration-300 ease-in-out absolute top-14 right-0 bg-dgray rounded-[8px] overflow-hidden`}
            >
              <div className="transition-all duration-300 ease-in-out flex justify-left items-center gap-[12px] px-[24px] py-[6px] hover:bg-[#282828]">
                <div className="flex justify-center items-center w-[32px] h-[32px]">
                  <Image width={28} height={28} alt="" src="/deposit.svg" />
                </div>
                <p className="py-[12px] transition-all duration-300 ease-in-out uppercase font-semibold hover:text-white text-[16px] text-">
                  Deposit
                </p>
              </div>
            </div> */}
          ...
          {/* <p className="transition-all duration-300 ease-in-out font-semibold text-[16px] text-purple uppercase group-hover:text-dgray">
              Roll App
            </p> */}
          {/* <div
              className={`transition-all duration-300 ease-in-out flex items-center justify-center w-[16px] h-[16px] ${
                dropDown ? "rotate-180" : "rotate-0"
              }`}
            >
              <svg
                className="transition-all duration-300 ease-in-out fill-current text-lgray"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M8.49989 13.1741C8.10265 13.6155 7.41055 13.6155 7.0133 13.1741L0.258669 5.66897C-0.320501 5.02544 0.136191 4 1.00196 4L14.5112 4C15.377 4 15.8337 5.02544 15.2545 5.66897L8.49989 13.1741Z" />
              </svg>
            </div> */}
          {/* </div> */}
        </div>
        ...
        {/* Humberger */}
        <div
          className="flex lg:hidden flex-col justify-center items-center gap-[5px] w-[32px] h-[32px]"
          onClick={humberger}
        >
          <span
            className={`transition-all duration-300 ease-in-out w-[24px] h-[3px] bg-white rounded ${
        ...
        <div
          ...
          ${
            menu === true
              ? "opacity-100 transform scale-y-100 origin-top py-[16px] top-20 z-10"
              : "opacity-0 transform scale-y-0 origin-top py-0 top-12 z-[-1]"
          } flex flex-col gap-4 px-6 overflow-hidden absolute flex flex-col lg:hidden border-2 border-white border-opacity-10 right-0 w-full rounded-[16px] bg-purple transition-all duration-600 ease-in-out`}
        >
          ...
          {/* dApp Button */}
          {/* <div
            className="group w-fit relative gap-[12px] px-[24px] py-[12px] flex items-center rounded-[8px] bg-dgray cursor-pointer"
            // onClick={openDropDown}
          > */}
          {/* drop down menu */}
          ...
          {/* <div
              ...
              className={`${
                dropDown
                  ? `opacity-100 transform scale-x-100 origin-left`
                  : `opacity-0 transform scale-x-0 origin-left`
              } w-[max-content] transition-all duration-300 ease-in-out absolute bottom-0 left-[136px] bg-dgray rounded-[8px] overflow-hidden`}
            >
              <div className="transition-all duration-300 ease-in-out flex justify-left items-center gap-[12px] px-[24px] py-[6px] hover:bg-[#282828]">
                <div className="flex justify-center items-center w-[32px] h-[32px]">
                  <Image
          ...
          {/* <p className="transition-all duration-300 ease-in-out font-semibold text-[16px] text-lgray">
              dAPPs
            </p>
            <div
              className={`transition-all duration-300 ease-in-out flex items-center justify-center w-[16px] h-[16px] ${
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <path d="M13.1741 7.2567C13.6155 7.65394 13.6155 8.34604 13.1741 8.74329L5.66897 15.4979C5.02544 16.0771 4 15.6204 4 14.7546L4 1.24535C4 0.379584 5.02544 -0.0771095 5.66897 0.502061L13.1741 7.2567Z" />
              </svg>
            </div>
          </div> */}
        </div>
